  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-1/4 left-1/4 w-32 h-32">
        ...
        <div className="ripple w-full h-full" style={{ animationDelay: '1s' }}></div>
        <div className="ripple w-full h-full" style={{ animationDelay: '2s' }}></div>
      </div>
      
      <div className="absolute bottom-1/4 right-1/4 w-24 h-24">
        <div className="ripple w-full h-full" style={{ animationDelay: '0.5s' }}></div>
        <div className="ripple w-full h-full" style={{ animationDelay: '1.5s' }}></div>
      </div>
    </div>
  );
};
